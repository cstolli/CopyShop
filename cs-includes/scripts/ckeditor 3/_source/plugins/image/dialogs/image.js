												...
												},*/
												{
													...
													setup : function( type, element )
													{
														if ( type == IMAGE )
														{
															...
															value = ( marginRightPx == marginRightPx ) && marginRightPx;
															//marginRightPxisNaN ( parseInt( value, 10 ) ) && ( value = element.getAttribute( 'vspace' ) );
															this.setValue( value );
														}
													},
													commit : function( type, element, internalCommit )
												...
												},
												{
													...
													setup : function( type, element )
													{
														if ( type == IMAGE )
														{
															...
															value = ( marginLeftPx == marginLeftPx ) && marginLeftPx;
															//marginRightPxisNaN ( parseInt( value, 10 ) ) && ( value = element.getAttribute( 'vspace' ) );
															this.setValue( value );
														}
													},
												...
												},
												{
													...
													setup : function( type, element )
													{
														if ( type == IMAGE )
														{
															var value,
																...
																marginTopStyle = element.getStyle( 'margin-right' ),
															...
															value = ( marginTopPx == marginTopPx ) && marginTopPx;
															//marginRightPxisNaN ( parseInt( value, 10 ) ) && ( value = element.getAttribute( 'vspace' ) );
															this.setValue( value );
														}
													},
													...
													setup : function( type, element )
													{
														if ( type == IMAGE )
														{
															...
															value = ( marginBottomPx == marginBottomPx ) && marginBottomPx;
															//marginRightPxisNaN ( parseInt( value, 10 ) ) && ( value = element.getAttribute( 'vspace' ) );
															this.setValue( value );
														}
													},
