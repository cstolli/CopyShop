...
YAHOO.util.Dom.setStyle(overlay, 'height', uiLayer.bottom-uiLayer.top + "px");
	...
	YAHOO.widget.Uploader.SWFURL = "/bling/YUI/2.6.0/build/uploader/assets/uploader.swf";
	...
	if (fileList != null) {
		...
		uploader.uploadAll("http://bling.honeyfund.com/bling/_include/uploader/upload.php", "POST", null, "Filedata");
	}	
	}
	...
	function onUploadError(event) {
		alert(event.type + ' '+ event.id + ' ' + event.status);
	}
