<html>
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="tools/menu/css/admin.css"/>

        <script type="text/javascript" src="tools/menu/scripts/jquery.js"></script>

        <script type="text/javascript" src="tools/menu/scripts/jquery.tablednd_0_5.js"></script>

        <script type="text/javascript" src="tools/menu/scripts/json.js"></script>

        <script type="text/javascript" src="tools/menu/menu.js"></script> 
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function(){
                ...
                $.getJSON("tools/menu/menu_service.php?function=load", function(json) {
        ...
        <div id="itemFormDiv" class="itemEditPane" style="display:none;">
            ...
            <form action="#" id="itemForm">
                ...
                <div class="itemTitleWrapper">
                    ...
                    <textarea rows="1" cols="50" scrollable="no" class="noyui" id="fieldLabel" name="fieldLabel"></textarea>
                ...
                <div class="itemTextWrapper">
                    ...
                    <textarea rows="20" cols="50" id="fieldText" class="noyui" name="fieldText"></textarea>
