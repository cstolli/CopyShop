...
<form style="display:block; visibility:visible;" action="cs-includes/newmail.php" enctype="multipart/form-data" id="inquiry" method="post" name="inquiry" target="_self">
						<h5 class="p1">
							CONTACT</h5>
						...
						<p class="p1">
							Event Format: <select name="format" size="1"><option value="buffet">buffet</option><option value="plated">plated</option><option value="sit-down">sit-down</option></select><br />
							</p>
						...
						<p class="p1">
							Specify any dietary restrictions:<br />
							<textarea cols="50" name="restrictions" rows="5"></textarea><br />

							<br />
                            <input name="to" type="hidden" value="catering@zinrestaurant.com">
                            <input name="email" type="hidden" value="catering@zinrestaurant.com">
